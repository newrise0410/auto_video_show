...
|---|---|---|---|---|---|
| chatterbox | OK | MIT (PerTh 워터마크 자동 삽입) | 가능 | cuda | 13.4초 |
...
| 문장 | 길이 | 합성 | RTF | 파일 |
|---|---|---|---|---|
| codeswitch | 3.44초 | 8.66초 | 2.52 | [01_codeswitch.wav](chatterbox/01_codeswitch.wav) |
| numbers | 6.00초 | 4.11초 | 0.68 | [02_numbers.wav](chatterbox/02_numbers.wav) |
| proper_noun | 3.88초 | 2.83초 | 0.73 | [03_proper_noun.wav](chatterbox/03_proper_noun.wav) |
| range | 4.76초 | 3.41초 | 0.72 | [04_range.wav](chatterbox/04_range.wav) |
| plain | 3.84초 | 2.88초 | 0.75 | [05_plain.wav](chatterbox/05_plain.wav) |
